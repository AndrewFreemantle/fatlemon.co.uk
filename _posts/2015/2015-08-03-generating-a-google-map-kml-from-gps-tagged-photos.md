...
<p class="wp-caption-text">The resulting `points.kml` opened in Google Earth</p>
...
![Google world map overlaid with route generated from digital photo metadata]({{ site.imageurl }}2015/photo-mapper-google-map-route.jpg)
<p class="wp-caption-text">The resulting `route.kml` opened in Google Maps. A little more involved and not without some limitations..</p>
...
<p class="wp-caption-text">Importing the KML file into Google Maps is pretty straightforward but requires a Google+ account</p>
...
<p class="wp-caption-text">Google Maps will only import the first 10 layers and 2000 features from this KML file.</p>
